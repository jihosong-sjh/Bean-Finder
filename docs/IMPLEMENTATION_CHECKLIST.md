...
| 완료 | ID | 우선순위 | 작업 | 상태 |
| --- | --- | --- | --- | --- |
| [ ] | IMP-059 | P0 | 비교함 localStorage 유틸 구현 | 대기 |
| [ ] | IMP-060 | P0 | 비교함 추가/제거 hook 또는 state 구현 | 대기 |
| [ ] | IMP-061 | P0 | 원두 카드 비교함 버튼 연결 | 대기 |
| [ ] | IMP-062 | P1 | 비교함 미니 바 구현 | 대기 |
| [ ] | IMP-063 | P0 | 비교 화면 구현 | 대기 |
| [ ] | IMP-064 | P0 | 비교 테이블/모바일 비교 UI 구현 | 대기 |
| [ ] | IMP-065 | P0 | 비교함 최대 4개 제한 구현 | 대기 |
| [ ] | IMP-066 | P1 | 카테고리 화면 구현 | 대기 |
| [ ] | IMP-067 | P1 | 랭킹 화면 구현 | 대기 |
| [ ] | IMP-068 | P1 | 잘못된 categoryKey/rankingKey 상태 구현 | 대기 |
